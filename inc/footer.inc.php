...
<footer>
    <nav id="navFooter">
        ...
        <ul>
            ...
            <a target="_blank" title="discord" href="https://discord.gg/starisland" ><img id="logoDiscord" class="sizeLogo" alt="logo discord" src="assets/img/logo_discord_rose.png"></a>
