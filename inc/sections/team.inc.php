<section id="team" class="fontImage1">
    ...
    ?>
        <figure>
            <img alt="avatar" class="teamAvatar" src="assets/img/avatar-<?php echo $e++;?>.png">
            <figcaption class="teamReseauxSociaux">
                ...
                <ul class="teamReseauxSociaux">
                    ...
                    <li><a title="resaux social" href="#"><img class="couleurSVG" alt="icone reseau social" src="assets/fontawesome-free/svgs/brands/youtube-square.svg"></a></li>
        ...
        <figure>
            <img alt="avatar" class="teamAvatar" src="assets/img/avatar-4.png">
            <figcaption class="teamReseauxSociaux">
                Role: Dev<br>
                Nom
                <ul class="teamReseauxSociaux">
